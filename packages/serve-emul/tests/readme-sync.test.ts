...
describe("package README generation", () => {
  test("rewrites repository links for the packed package deterministically", () => {
    const root = [
      "# Example",
      "",
      "[`packages/serve-emul/package.json`](packages/serve-emul/package.json)",
      "[`packages/serve-emul/CHANGELOG.md`](packages/serve-emul/CHANGELOG.md)",
      "[protocol](packages/serve-emul/docs/protocol.md)",
      "[contributing](CONTRIBUTING.md)",
      "Vendored at `packages/serve-emul/vendor/`.",
      "",
    ].join("\n");
    ...
    expect(renderPackageReadme(root)).toBe(
      [
        ...
        "[contributing](https://github.com/jiunshinn/serve-emul/blob/main/CONTRIBUTING.md)",
        "Vendored at `vendor/`.",
        "",
      ].join("\n"),
    );
  ...
  test("checked-in package README exactly matches the canonical root README", async () => {
    ...
    expect(packageReadme).toContain(
      "[`CONTRIBUTING.md`](https://github.com/jiunshinn/serve-emul/blob/main/CONTRIBUTING.md)",
    );
  });
