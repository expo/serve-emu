 ...
 * active server session and rendered from a blob URL.
 */
export function ScreenshotPanel() {
  ...
  useEffect(() => {
    replaceShot(null);
    setStatus("Ready");
  }, [deviceSession.serial, replaceShot]);
  ...
  const download = useCallback(() => {
    ...
    a.href = shot.url;
    a.download = downloadName(deviceSession.serial, shot.capturedAt);
    document.body.appendChild(a);
    a.click();
    a.remove();
  }, [shot, deviceSession.serial]);
